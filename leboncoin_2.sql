...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 13 juin 2023 à 18:46
...
(12, 'Un bel aquarium', 5, 20, 'Par contre, faudra le remplir chez vous... Car c\'est pas facile de transporter de l\'eau !', '2023-06-12 19:46:14', 0, 6, 15, 10);
...
INSERT INTO `utilisateur` (`id`, `pseudo`, `password`, `email`, `creation_compte`, `adresse`, `nom`, `prenom`, `est_theme_clair`) VALUES
(1, 'Trytoon', '$2y$10$4wKTtIn2YxNJQ/NNwGMIMOankoLQb/X.O5tt5PKxqfHoGrOd2ig2u', 'jkimenau123@gmail.com', '2023-05-26 10:36:53', 1, 'Jean', 'Némarre', 1),
(15, 'Sigmind', '$2y$10$7.tZWYxrA69YcksRtQB9OeryAqRtt4oZ.cq8Xaxw2qSRX7yw/3v3i', 'sigmind@gmail.com', '2023-06-12 15:40:33', NULL, NULL, NULL, 1),
(16, 'Tatsuya', '$2y$10$VP/AkPl78AxRU7niO161zuNQkqTmtJuY5104S7LNPN1T3tMcgJYwG', 'tatsuya28@gmail.com', '2023-06-13 13:27:06', NULL, NULL, NULL, 1);
